                            ...
                            <div>
                                ...
                                <div class="px-5 sm:px-6 pt-0 pb-4">
                                    ...
                                    <div class="flex items-center justify-between py-2.5 px-3.5 bg-[#FAF9FC] rounded-xl border border-gray-100/90 text-xs mb-4">
                                        ...
                                        <div class="h-6 w-[1px] bg-gray-200"></div>
                                        <div class="flex flex-col items-center justify-center flex-1 min-h-[34px] px-0.5 text-center">
                                            <template x-if="seller.has_reviews && seller.rating > 0">
                                                <div class="flex flex-col items-center">
                                                    <div class="flex items-center gap-1">
                                                        ...
                                                        <span class="font-extrabold text-gray-900 text-[13.5px]" x-text="seller.rating_formatted"></span>
                                                    </div>
                                                    <span class="text-[10.5px] text-gray-400 font-medium">Rating</span>
                                                </div>
                                            </template>
                                            <template x-if="!seller.has_reviews || seller.rating == 0">
                                                <span class="text-[11.5px] sm:text-[12px] font-bold text-gray-500 leading-tight">
                                                    Belum ada ulasan
                                                </span>
                                            </template>
                                        </div>
    ...
    function registerFollowedStores() {
        Alpine.data('followedStoresManager', () => ({
            stores: @js($followedSellers->map(function ($s) {
                ...
                $rating = $hasReviews
                    ? round((float) ($s->reviews_avg_rating ?? 0), 1)
                    : ($isDemo ? 4.9 : 0.0);
                $ratingFormatted = $hasReviews
