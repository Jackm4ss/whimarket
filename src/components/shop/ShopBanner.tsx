  ...
  return (
    <div className="w-full max-w-[1536px] mx-auto px-4 sm:px-8 md:px-12 lg:px-16 xl:px-20 pt-4 pb-6">
      ...
      <div className="relative w-full rounded-2xl sm:rounded-3xl bg-[#5022CE] overflow-hidden min-h-[175px] sm:min-h-[185px] lg:h-[200px] flex items-center justify-between shadow-lg shadow-[#5022CE]/15">
        {/* Mobile: Clean vector curves background (no shoe/bag blocking text) */}
        <div className="absolute right-0 top-0 bottom-0 h-full w-auto pointer-events-none z-0 sm:hidden">
          <img
            src="/assets/banner-vector-bg.png"
            alt=""
            className="h-full w-auto object-cover object-right opacity-50"
          />
        </div>

        {/* Desktop / Tablet: Full composite asset with stage, sneaker, bag, sticky note */}
        ...
        <div className="relative z-10 max-w-[560px] text-left pl-5 sm:pl-12 lg:pl-16 xl:pl-[72px] pr-2 sm:pr-4 py-5 sm:py-6 flex flex-col justify-center">
          ...
          <h1 className="text-[26px] sm:text-[32px] lg:text-[38px] xl:text-[40px] font-extrabold text-white tracking-[-0.03em] leading-[1.22] mb-3">
            ...
            <span className="block">
              Preloved <span className="text-[#F7AC1D]">Favoritmu</span>
            </span>
          </h1>
